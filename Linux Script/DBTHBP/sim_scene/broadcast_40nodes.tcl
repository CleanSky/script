...
set tracefd	[open broadcast_40nodes.tr w];#开启Trace跟踪文件
...
source "../random_initial_data/nodes_40nodes.txt";#节点的创建
source "../random_initial_data/location_40nodes.txt";#节点位置
source "../random_initial_data/speed_40nodes.txt";#节点运动速度
