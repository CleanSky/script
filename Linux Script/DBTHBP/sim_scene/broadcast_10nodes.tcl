...
set tracefd	[open broadcast_10nodes.tr w];#开启Trace跟踪文件
...
source "../random_initial_data/nodes_10nodes.txt";#节点的创建
source "../random_initial_data/location_10nodes.txt";#节点位置
source "../random_initial_data/speed_10nodes.txt";#节点运动速度
