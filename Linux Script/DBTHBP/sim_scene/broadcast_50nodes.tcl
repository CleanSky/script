...
set tracefd	[open broadcast_50nodes.tr w];#开启Trace跟踪文件
...
source "../random_initial_data/nodes_50nodes.txt";#节点的创建
source "../random_initial_data/location_50nodes.txt";#节点位置
source "../random_initial_data/speed_50nodes.txt";#节点运动速度
