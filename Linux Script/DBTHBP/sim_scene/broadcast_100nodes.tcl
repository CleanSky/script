...
set tracefd	[open broadcast_100nodes.tr w];#开启Trace跟踪文件
...
source "../random_initial_data/nodes_100nodes.txt";#节点的创建
source "../random_initial_data/location_100nodes.txt";#节点位置
source "../random_initial_data/speed_100nodes.txt";#节点运动速度
